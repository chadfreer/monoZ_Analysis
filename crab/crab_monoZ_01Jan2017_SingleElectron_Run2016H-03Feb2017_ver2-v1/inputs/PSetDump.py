...
process.cleanedPatJets = cms.EDProducer("PATJetCleaner",
    checkOverlaps = cms.PSet(
        electrons = cms.PSet(
            ...
            src = cms.InputTag("preppedElectrons")
        ),
        muons = cms.PSet(
            algorithm = cms.string('byDeltaR'),
            checkRecoComponents = cms.bool(False),
...
process.egmGsfElectronIDs = cms.EDProducer("VersionedGsfElectronIdProducer",
    ...
    physicsObjectSrc = cms.InputTag("calibratedPatElectrons")
)
...
process.egmPhotonIDs = cms.EDProducer("VersionedPhotonIdProducer",
    ...
    physicsObjectSrc = cms.InputTag("calibratedPatPhotons")
)
...
process.electronMVAValueMapProducer = cms.EDProducer("ElectronMVAValueMapProducer",
    ...
    srcMiniAOD = cms.InputTag("calibratedPatElectrons")
)
...
process.heepIDVarValueMaps = cms.EDProducer("ElectronHEEPIDValueMapProducer",
    ...
    elesMiniAOD = cms.InputTag("calibratedPatElectrons"),
...
process.patPFMet = cms.EDProducer("PATMETProducer",
    ...
    srcJetSF = cms.string('AK4PFchs'),
    srcJets = cms.InputTag("cleanedPatJets"),
    srcLeptons = cms.VInputTag(cms.InputTag("preppedElectrons"), cms.InputTag("preppedMuons"), cms.InputTag("preppedPhotons")),
...
process.pfCandsForUnclusteredUnc = cms.EDProducer("CandPtrProjector",
    ...
    veto = cms.InputTag("preppedPhotons")
)
...
process.photonIDValueMapProducer = cms.EDProducer("PhotonIDValueMapProducer",
    ...
    srcMiniAOD = cms.InputTag("calibratedPatPhotons"),
...
process.preppedPhotons = cms.EDProducer("PhotonPrep",
    ...
    triggerPathsForMinPrescale = cms.vstring('HLT_Photon50_R9Id90_HE10_IsoM_v', 
...
process.preppedTaus = cms.EDProducer("TauPrep",
    ...
    minPtAnyVariation = cms.double(18.0),
...
process.shiftedPatMETCorrElectronEnDown = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("preppedElectrons"),
...
process.shiftedPatMETCorrMuonEnDown = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("preppedMuons"),
...
process.shiftedPatMETCorrPhotonEnDown = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("preppedPhotons"),
...
process.shiftedPatMETCorrTauEnDown = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("preppedTaus"),
...
process.subMETchargedBarrel = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('charge != 0 && abs(eta) < 1.3'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMETchargedEndcap = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('charge != 0 && abs(eta) > 1.6 && abs(eta) < 2.4'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMETemHF = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 2 && abs(eta) > 3'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMEThadronicHF = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 1 && abs(eta) > 3'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)
...
process.subMETneutralBarrel = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 130 && abs(eta) < 1.3'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMETneutralEndcap = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 130 && abs(eta) > 1.6 && abs(eta) < 2.4'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMETneutralEndcapNoTracker = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 130 && abs(eta) > 2.4 && abs(eta) < 3'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMETphotonBarrel = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 22 && abs(eta) < 1.3'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMETphotonEndcap = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 22 && abs(eta) > 1.6 && abs(eta) < 2.4'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)


process.subMETphotonEndcapNoTracker = cms.EDProducer("SubMETProducer",
    dzToPrimaryVertex = cms.double(999.0),
    packedCandidatesSrc = cms.InputTag("packedPFCandidates"),
    selection = cms.string('pdgId == 22 && abs(eta) > 2.4 && abs(eta) < 3'),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)
...
process.counters = cms.EDAnalyzer("EventCounters",
    ...
    metaData = cms.PSet(
        conditions = cms.string('Run2016H-03Feb2017_ver2-v1'),
        dataset = cms.string('SingleElectron'),
        gitversion = cms.string('"af63a82*"'),
        globalTag = cms.string('80X_dataRun2_Prompt_v16'),
        inputFiles = cms.vstring(),
        isMC = cms.string('No')
    ),
    nLHEWeights = cms.uint32(9)
)


process.events = cms.EDAnalyzer("EventTupler",
    ...
    genEventInfoSrc = cms.InputTag("generator"),
    genParticleCut = cms.string('isHardProcess'),
    ...
    subMetSrcVect = cms.VInputTag("subMETchargedBarrel", "subMETneutralBarrel", "subMETphotonBarrel", "subMETchargedEndcap", "subMETneutralEndcap", 
        "subMETphotonEndcap", "subMETneutralEndcapNoTracker", "subMETphotonEndcapNoTracker", "subMEThadronicHF", "subMETemHF", 
        "subMETmissingHt"),
    tauSrc = cms.InputTag("preppedTaus"),
    trackMetSrc = cms.InputTag("trackMETs"),
    triggerBits = cms.InputTag("TriggerResults","","HLT"),
    uncleanedMetSrc = cms.InputTag("slimmedMETsUncorrected","","PAT"),
    vertexSrc = cms.InputTag("offlineSlimmedPrimaryVertices")
)
...
process.tuplePath = cms.Path(process.counters+process.triggerFilter+process.leptonCountFilter+process.events)
