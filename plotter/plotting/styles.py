...
styles = {
    "Nonresonant":
        {
            "fill": ROOT.TAttFill(ROOT.kViolet-4, 1001),
            "line": ROOT.TAttLine(getColorDark(ROOT.kViolet-4), ROOT.kSolid, 1),
            "marker": None,
        },
    "DYTauTau":
        {
    ...
    "WZ3lnu":
        {
            "fill": ROOT.TAttFill(ROOT.kBlue+1, 1001),
            "line": ROOT.TAttLine(getColorDark(ROOT.kBlue+1), ROOT.kSolid, 1),
            "marker": None,
        },
    "ZZ4l":
        {
            "fill": ROOT.TAttFill(ROOT.kGreen-6, 1001),
            "line": ROOT.TAttLine(getColorDark(ROOT.kGreen-6), ROOT.kSolid, 1),
            "marker": None,
        },
    "Other2l":
        {
    ...
    "DrellYan":
        {
            "fill": ROOT.TAttFill(getColor("#01FFFF"), 1001),
            "line": ROOT.TAttLine(getColorDark("#01FFFF"), ROOT.kSolid, 1),
            "marker": None,
        },
    "WJets":
        {
